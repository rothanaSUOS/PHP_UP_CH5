            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-info testing">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white" href="orderLists.php">Order Lists</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white" href="foodPost.php">Add food(Admin)</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="adminallFoodList.php">All food list(admin)</a>
                        </li>
                    </ul>
